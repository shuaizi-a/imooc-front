;(function () {
  ...
  n.initImg = function () {
    ...
    t.onerror = function () {
      if (
        ...
        window.location.protocol === 'file:' &&
          ((u = n.options.maxLoadCount), console.error("can't load pic resource file from File protocal. Please try http or https")),
    ...
    t.setSrc = function () {
      ...
      ;(r && r !== '') || (r = 'https://picsum.photos/' + n.options.width + '/' + n.options.height + '/?image=' + Math.round(Math.random() * 200))
      f
    ...
    var r,
      ...
      s = function (u) {
        ...
        e.spliced && e.verified
          ? (n.sliderContainer.classList.add('sliderContainer_success'), i(n.options.onSuccess) && n.options.onSuccess.call(n.$element, f))
